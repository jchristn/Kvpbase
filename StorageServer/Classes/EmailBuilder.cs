...
namespace Kvpbase
{
    ...
    public static class EmailBuilder
    {
            ...
            string emailAddress)
        {
            ...
            if (includeLogo)
            {
                body += "       <table width='800' cellspacing='0' cellpadding='0' border='0' align='center'>";
                body += "        <tbody>";
                body += "         <tr valign='top'>";
                body += "          <td height='80' width='800' style='background: url('" + logoUrl + "') left no-repeat; font-family:helvetica neue, arial, helvetica, sans-serif; letter-spacing:-0.03em; text-decoration:none; text-align:left;padding:10px 30px 4px; vertical-align:middle'>";
