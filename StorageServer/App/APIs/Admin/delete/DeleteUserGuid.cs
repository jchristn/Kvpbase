    ...
    public partial class StorageServer
    {
        public static HttpResponse DeleteUserGuid(RequestMetadata md)
        {
            ...
            try
            {
                ...
                if (req == null)
                {
                    Logging.Log(LoggingModule.Severity.Warn, "DeleteUserGuid null request after deserialization, returning 400");
            ...
            {
                Logging.Log(LoggingModule.Severity.Warn, "DeleteUserGuid unable to deserialize request body");
                return new HttpResponse(md.CurrentHttpRequest, false, 400, null, "application/json",
                    new ErrorResponse(2, 400, "Unable to deserialize request body.", null).ToJson(),
                    true);
            }
            ...
            {
                Logging.Log(LoggingModule.Severity.Warn, "DeleteUserGuid unable to find value for guid in request body");
                return new HttpResponse(md.CurrentHttpRequest, false, 400, null, "application/json",
            ...
            {
                Logging.Log(LoggingModule.Severity.Warn, "DeleteUserGuid directory " + homeDirectory + " does not exist");
            ...
            {
                Logging.Log(LoggingModule.Severity.Warn, "DeleteUserGuid false returned from attempt to delete " + homeDirectory + userGuid);
                return new HttpResponse(md.CurrentHttpRequest, false, 500, null, "application/json",
                    new ErrorResponse(4, 500, "Unable to delete container.", null).ToJson(),
                    true);
            }

            Logging.Log(LoggingModule.Severity.Debug, "DeleteUserGuid successfully deleted " + homeDirectory);
