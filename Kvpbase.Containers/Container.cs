...
namespace Kvpbase.Containers
{
    ...
    public class Container : IDisposable
    {
        ...
        public void Destroy()
        {
            ...
            if (File.Exists(Settings.DatabaseFilename)) File.Delete(Settings.DatabaseFilename);
            try
            {
                if (Directory.Exists(Settings.ObjectsDirectory)) Directory.Delete(Settings.ObjectsDirectory, true);
            }
            catch (Exception)
            {
            ...
            try
            {
                if (Directory.Exists(Settings.RootDirectory)) Directory.Delete(Settings.RootDirectory, true);
            }
            catch (Exception)
            {
