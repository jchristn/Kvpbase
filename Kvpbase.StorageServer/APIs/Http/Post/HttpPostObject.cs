    ...
    public partial class StorageServer
    {
        public static HttpResponse HttpPostObject(RequestMetadata md)
        {
            ...
            { 
                ...
                {
                    _Logging.Warn("HttpPostObject unable to find container " + md.Params.UserGuid + "/" + md.Params.Container);
                ...
                if (!isPublicWrite)
                {
                    ...
                    {
                        _Logging.Warn("HttpPostObject unauthorized unauthenticated write attempt to object " + md.Params.UserGuid + "/" + md.Params.Container + "/" + md.Params.ObjectKey);
                ...
                if (md.Perm != null)
                {
                    ...
                    {
                        _Logging.Warn("HttpPostObject unauthorized write attempt to object " + md.Params.UserGuid + "/" + md.Params.Container + "/" + md.Params.ObjectKey);
                        return new HttpResponse(md.Http, 401, null, "application/json",
                            Encoding.UTF8.GetBytes(Common.SerializeJson(new ErrorResponse(3, 401, "Unauthorized.", null), true)));
                    }
                }
                ...
                {
                    _Logging.Warn("HttpPostObject object " + md.Params.UserGuid + "/" + md.Params.Container + "/" + md.Params.ObjectKey + " already exists");
                ...
                {
                    _Logging.Warn("HttpPostObject object size too large (" + md.Http.ContentLength + " bytes)");
                ...
                {
                    _Logging.Warn("HttpPostObject unable to write temporary file for " + md.Params.UserGuid + "/" + md.Params.Container + "/" + md.Params.ObjectKey);
                ...
                {
                    _Logging.Warn("HttpPostObject unable to attach stream for for " + md.Params.UserGuid + "/" + md.Params.Container + "/" + md.Params.ObjectKey);
                    return new HttpResponse(md.Http, 500, null, "application/json",
                ...
                {
                    _Logging.Warn("HttpPostObject unable to write object " + md.Params.UserGuid + "/" + md.Params.Container + "/" + md.Params.ObjectKey + ": " + error.ToString());
                ...
                { 
                    ...
                    {
                        _Logging.Warn("HttpPostObject unable to replicate operation to one or more nodes");
