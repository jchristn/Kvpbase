...
namespace Kvpbase
{
    public partial class StorageServer
    {
        public static HttpResponse HttpDeleteContainer(RequestMetadata md)
        {
            ...
            if (md.User == null)
            {
                _Logging.Warn("HttpDeleteContainer no authentication material");
            ...
            {
                _Logging.Warn("HttpDeleteContainer user " + md.User.Guid + " attempting to create container in user " + md.Params.UserGuid);
                return new HttpResponse(md.Http, 401, null, "application/json",
                    Encoding.UTF8.GetBytes(Common.SerializeJson(new ErrorResponse(3, 401, "Unauthorized.", null), true)));
            }
            ...
            {
                _Logging.Warn("HttpDeleteContainer unauthorized delete attempt to container " + md.Params.UserGuid + "/" + md.Params.Container);
                return new HttpResponse(md.Http, 401, null, "application/json",
                    Encoding.UTF8.GetBytes(Common.SerializeJson(new ErrorResponse(3, 401, "Unauthorized.", null), true)));
            }
            ...
            {
                _Logging.Warn("HttpDeleteContainer container " + md.Params.UserGuid + "/" + md.Params.Container + " does not exist");
            ...
            if (md.Params.AuditLog)
            {
                ...
                _Logging.Info("HttpDeleteContainer cleared audit log for container " + md.Params.UserGuid + "/" + md.Params.Container);
            ...
            else
            {
                ...
                _Logging.Info("HttpDeleteContainer deleted container " + md.Params.UserGuid + "/" + md.Params.Container);
                return new HttpResponse(md.Http, 204, null);
            }
